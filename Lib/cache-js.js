...
var cacheJs = {
    ...
    injectFile: function(name, resource) {
        ...
        if(resource.type=="script"){
            document.body.appendChild(resourceTag);
            document.body.removeChild(resourceTag)
            
            document.querySelectorAll('.remove-me').forEach(function(a) {
                a.remove()
              })
            //a.remove()
            //console.log(a);
                ...
                if ([304, 302, 200, 201, 202].indexOf(x.status) !== -1) {
                    ...
                    switch (resource.type) {
                        ...
                        case 'script':
                           ...
                           // resourceTag.setAttribute('class', "a");
                            break;
                        default:
